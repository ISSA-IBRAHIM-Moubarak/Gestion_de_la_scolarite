...
use App\Form\EditSuperAdminType;
...
class SuperAdminController extends AbstractController
{
    ...
    /**
     * @Route("/SuperAdmin", name="list_SuperAdmin")
     */
    public function SuperAdmin(): Response
    {
        $user = $this->getUser();
        $users = $this->userRepository->getUsersBySuperAdmin();
        $resultat = "";
        $classe = "";
        $roles = $user->getRoles();
        $role = $roles[0];
        if($role !== Constantes::ROLE_SUPER_ADMIN ){
            ...
            return $this->render('superAdmin/superAdmin.html.twig', [
    ...
    /**
     * @Route("/SuperAdmin/new", name="create_SuperAdmin")
     */
    public function createSuperAdmin(Request $request): Response
    {
        ...
        if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
            ...
            if ($user) {
                return $this->redirectToRoute('list_SuperAdmin');
            } else {
                $resultat = "Echec de la creation!.";
                $classe = "alert alert-danger";
                return $this->render('superAdmin/superAdmin-form.html.twig', [
                    'action' => 'create',
    ...
    /**
     * @Route("/SuperAdmin/edit/{id}", name="edit_SuperAdmin")
     */
    public function editSuperAdmin(Request $request, User $user): Response
    {
        $users = $this->getUser();
        $roles = $users->getRoles();
        $role = $roles[0];
          
        $form = $this->createForm(EditSuperAdminType::class,$user);
        ...
        if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
            ...
            if ($user) {
                ...
                return $this->render('superAdmin/superAdmin-form-edit.html.twig', [
                    'action' => 'edit',
                    'user' => $user,
                    'form' => $form->createView(),'resultat' => $resultat,'classe' => $classe
                ]);
    ...
    /**
     * @Route("/desactiver/{id}", name="desabled_SuperAdmin")
     */
    public function desactiverSuperAdmin(Request $request, User $user_entity): Response
    {
        $user = $this->getUser();
        $roles = $user->getRoles();
        $role = $roles[0];    
    ...
    /**
     * @Route("/activer/{id}", name="enable_SuperAdmin")
     */
    public function activerSuperAdmin(Request $request, User $user_entity): Response
    {
        $user = $this->getUser();
        $roles = $user->getRoles();
        $role = $roles[0];    
    ...
    /**
     * @Route("/SuperAdmin/editpassword", name="edit_password")
     */
    public function editPassword(Request $request,UserRepository $userRepository): Response
    {
        ...
        if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
            ...
            if ($user) {
                ...
                return $this->render('superAdmin/password-form-edit.html.twig', [
                    'action' => 'edit',
                    'user' => $user,
                    'form' => $form->createView(),'resultat' => $resultat,'classe' => $classe
                ]);
    ...
    /**
     * @Route("/SuperAdmin/resetpassword", name="reset_password")
     */
    public function resetPassword(Request $request,UserRepository $userRepository): Response
    {
        ...
        if($role !== Constantes::ROLE_SUPER_ADMIN){
            ...
            $classe = "alert alert-danger";
            return $this->render('superAdmin/password-form-reset.html.twig', [
                'action' => 'edit',
                'user' => $user,
                'form' => $form->createView(),'resultat' => $resultat,'classe' => $classe
            ]);
